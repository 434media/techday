// Send Speaker KBYG email to all Tech Day speakers
// Run with: npx tsx scripts/send-speaker-kbyg-emails.ts
...
// All speaker emails (deduplicated)
...
async function main() {
  ...
  const subject = "Tech Day 2026 Speaker: Know Before You Go 📍"
