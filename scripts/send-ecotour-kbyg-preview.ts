// Preview Ecosystem Tours KBYG email — sends to jesse@434media.com only
// Run with: npx tsx scripts/send-ecotour-kbyg-preview.ts
...
async function main() {
  console.log("Sending Ecosystem Tours KBYG preview email to", PREVIEW_EMAIL)
