// Preview Tech Fuel Judge KBYG email — sends to jesse@434media.com
// Run with: npx tsx scripts/send-judge-kbyg-preview.ts
...
async function main() {
  console.log(`Sending judge KBYG preview to ${PREVIEW_EMAIL}\n`)

  const content = getJudgeContent("Ben")
  ...
  try {
    const result = await resend.emails.send({
      ...
      to: PREVIEW_EMAIL,
      replyTo: REPLY_TO,
      subject: "[PREVIEW] Tech Fuel 2026 Judge: Know Before You Go 📍",
      html,
    })
