// Preview KBYG (Know Before You Go) email for TechFuel 5 finalists — sends to jesse@434media.com only
// Run with: npx tsx scripts/send-kbyg-preview.ts
...
async function main() {
  console.log("Sending KBYG preview email to", PREVIEW_EMAIL)
