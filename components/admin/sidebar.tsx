...
type NavSection = "data" | "scheduling" | "content"
...
const NAV_ITEMS: NavItem[] = [
  ...
  { 
    label: "Judge Scheduling", 
    href: "/admin/semifinals-judges",
    section: "scheduling",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  { 
    label: "Pitch Scheduling", 
    href: "/admin/semifinals-pitches",
    section: "scheduling",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function AdminSidebar() {
  ...
  const dataItems = visibleNavItems.filter((item) => item.section === "data")
  const schedulingItems = visibleNavItems.filter((item) => item.section === "scheduling")
  const contentItems = visibleNavItems.filter((item) => item.section === "content")
